...
- 29 focused insight notes in `insights/`.
...
- Insights 21-29 are now expanded as long-form research artifacts with paper-by-paper context,
...
- Static-analysis-specific synthesis is now split into separate notes for custom lint rules,
  diagnostics-as-agent-interface, structural/static oracles, and fact models.
