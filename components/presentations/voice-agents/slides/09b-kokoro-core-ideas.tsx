...
export function KokoroCoreIdeasSlide() {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full max-w-5xl mx-auto px-8">
      ...
      <p className="text-xl text-muted-foreground mb-3 text-center max-w-4xl">
      ...
      <div className="w-full max-w-5xl mb-4">
        <div className="grid grid-cols-1 md:grid-cols-[0.9fr_auto_1.15fr_auto_1.25fr] gap-4 items-stretch">
          <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3">
            ...
            <h3 className="text-2xl font-bold text-primary mb-2">Raw Text → G2P → Phonemes</h3>
            <div className="inline-flex px-2 py-1 rounded-full bg-zinc-900/80 border border-zinc-700 text-sm font-mono text-muted-foreground mb-2">
              external G2P
            </div>
          ...
          <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3">
            ...
            <h3 className="text-2xl font-bold text-primary mb-3">Context + Prosody</h3>
            <div className="grid grid-cols-1 gap-3">
              <div className="relative rounded-lg border border-zinc-700 bg-zinc-950/40 p-2 pr-28">
                <div className="absolute top-2 right-2 px-2 py-1 rounded-full bg-blue-500/10 border border-blue-400/30 text-xs font-mono text-blue-300 whitespace-nowrap">
                  pre-trained / fine-tuned
                </div>
                <div className="text-base font-mono text-primary/80 mb-1">6.3M + 0.39M</div>
                <div className="text-lg font-semibold mb-1">PLBERT + Projection</div>
                <p className="text-base text-muted-foreground leading-relaxed">
                  Transformer context over phonemes
                </p>
              </div>
              <div className="relative rounded-lg border border-zinc-700 bg-zinc-950/40 p-2 pr-28">
                <div className="absolute top-2 right-2 px-2 py-1 rounded-full bg-emerald-500/10 border border-emerald-400/30 text-xs font-mono text-emerald-300 whitespace-nowrap">
                  trained end-to-end
                </div>
                <div className="text-base font-mono text-primary/80 mb-1">5.6M</div>
                <div className="text-lg font-semibold mb-1">TextEncoder</div>
                <p className="text-base text-muted-foreground leading-relaxed">
              ...
              <div className="relative rounded-lg border border-primary/30 bg-primary/5 p-2 pr-28">
                ...
                <div className="text-base font-mono text-primary/80 mb-1">16.2M</div>
                <div className="text-lg font-semibold mb-1">Prosody Predictor</div>
                <p className="text-base text-muted-foreground leading-relaxed">
          ...
          <div className="relative bg-primary/10 border border-primary/30 rounded-xl p-3 pr-24">
            ...
            <div className="absolute top-3 right-3 px-2 py-1 rounded-full bg-emerald-500/10 border border-emerald-400/30 text-xs font-mono text-emerald-300 whitespace-nowrap">
              trained end-to-end
            </div>
            <h3 className="text-2xl font-bold text-primary mb-2">Decoder / iSTFTNet</h3>
            <div className="text-base font-mono text-primary/90 mb-3">53.3M (~65% of model)</div>
