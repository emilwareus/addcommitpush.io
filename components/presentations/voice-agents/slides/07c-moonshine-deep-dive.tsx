export function MoonshineDeepDiveSlide() {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full max-w-6xl mx-auto px-8">
      ...
      <p className="text-base text-muted-foreground mb-5 text-center max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1.1fr_auto_0.7fr_auto_1fr] gap-3 w-full mb-5 items-stretch">
        <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3">
          <div className="text-xs font-mono text-primary/70 mb-1">Stage 1</div>
          <h3 className="text-lg font-bold text-primary mb-2">Frontend</h3>
          <div className="inline-flex px-2 py-0.5 rounded-full bg-primary/10 border border-primary/30 text-[10px] font-mono text-primary mb-2">
            no mel spectrogram
          </div>
        ...
        <div className="hidden md:flex items-center justify-center text-2xl text-primary/50">
          -&gt;
        </div>

        <div className="bg-primary/10 border border-primary/30 rounded-xl p-3">
          <div className="text-xs font-mono text-primary/70 mb-1">Stage 2</div>
          <h3 className="text-lg font-bold text-primary mb-2">Encoder</h3>
          <div className="inline-flex px-2 py-0.5 rounded-full bg-primary/10 border border-primary/30 text-[10px] font-mono text-primary mb-2">
        ...
        <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3">
          <div className="text-xs font-mono text-primary/70 mb-1">Stage 3</div>
          <h3 className="text-lg font-bold text-primary mb-2">Adapter</h3>
          <div className="inline-flex px-2 py-0.5 rounded-full bg-zinc-900/80 border border-zinc-700 text-[10px] font-mono text-muted-foreground mb-2">
            bridge
          </div>
          <ul className="space-y-1.5 text-xs text-muted-foreground">
        ...
        <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3">
          <div className="text-xs font-mono text-primary/70 mb-1">Stage 4</div>
          <h3 className="text-lg font-bold text-primary mb-2">Decoder</h3>
          <div className="inline-flex px-2 py-0.5 rounded-full bg-zinc-900/80 border border-zinc-700 text-[10px] font-mono text-primary/80 mb-2">
            RoPE + SwiGLU
          </div>
          <ul className="space-y-1.5 text-xs text-muted-foreground">
      ...
      <div className="w-full max-w-4xl mb-4">
        <div className="grid grid-cols-3 gap-3 text-center">
          {[
            ...
            >
              <div className="text-sm font-semibold text-primary">{m.size}</div>
              <div className="text-lg font-mono text-zinc-300">{m.total}</div>
              <div className="text-[10px] font-mono text-muted-foreground">{m.split}</div>
              <div className="text-[9px] text-muted-foreground/60">front + enc + adapt + dec</div>
            </div>
          ))}
        </div>
      </div>
