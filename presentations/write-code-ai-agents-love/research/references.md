...
| D34 | [Anthropic: How Claude Code works in large codebases](https://claude.com/blog/how-claude-code-works-in-large-codebases-best-practices-and-where-to-start) | `articles/anthropic-large-codebases-claude-code.html` | Vendor/practitioner guidance: large-codebase success depends on layered context, hooks, skills, plugins, LSP, MCP, and subagents, not model choice alone. |
| D35 | [Builder.io: Improve your AI code output with AGENTS.md](https://www.builder.io/blog/agents-md) | `articles/builder-agents-md.html` | Popular AGENTS.md guide: small project instructions, commands, guardrails, and structure hints reduce repeated repo rediscovery. |
| D36 | [Builder.io: How I use Claude Code](https://www.builder.io/blog/claude-code) | `articles/builder-claude-code-tips.html` | Popular Claude Code workflow tips, including parallel instances scoped to different codebase areas. |
| D37 | [Boris Tane: How I Use Claude Code](https://boristane.com/blog/how-i-use-claude-code/) | `articles/boris-tane-how-i-use-claude-code.html` | Practitioner workflow: research first, persistent markdown findings, reviewed plans before implementation. |
| D38 | [Jon Atkinson: How I use Claude Code](https://www.jonatkinson.co.uk/blog/how-i-use-claude-code/) | `articles/jon-atkinson-how-i-use-claude-code.html` | Practitioner workflow: two-agent critique loop, implementation plans, phase-by-phase verification, context resets. |
| D39 | [AI Hackers: AGENTS.md practical guide](https://aihackers.net/posts/agents-md-practical-guide/) | `articles/aihackers-agents-md-practical-guide.html` | Popular synthesis: concise rules, copy-paste commands, progressive disclosure, and single canonical AGENTS.md reduce context bloat and tool drift. |
| D40 | [LocalCan: How I use Claude Code on large projects](https://www.localcan.com/blog/claude-code-workflow-for-large-projects) | `articles/localcan-claude-code-large-projects.html` | Practitioner article: serious agentic coding bottleneck becomes context; lead/implementer/reviewer roles keep scopes tight. |
| D41 | [Coder: AI Coder best practices](https://coder.com/docs/ai-coder/best-practices) | `articles/coder-ai-coder-best-practices.html` | Organizational guidance: choose concrete use cases, package repeatable workflows, and run agents in reproducible workspaces. |
| D42 | [Agentic Coding Principles and Practices](https://agentic-coding.github.io/) | `articles/agentic-coding-principles.html` | Community guide: agentic coding needs planning, verification, accountability, and risk controls beyond prompting. |
| D43 | [HN: Claude Code best practices for agentic coding](https://news.ycombinator.com/item?id=43735550) | `articles/hn-claude-code-best-practices.html` | High-engagement HN discussion around Claude Code practices and supervising multiple agents in one codebase. |
| D44 | [HN: How I use every Claude Code feature](https://news.ycombinator.com/item?id=45786738) | `articles/hn-every-claude-code-feature.html` | HN discussion includes AGENTS.md/CLAUDE.md loading details and skepticism about whether agents follow persistent guidance. |
| D45 | [HN search: AGENTS.md threads](https://hn.algolia.com/?q=AGENTS.md) | `articles/hn-search-agents-md.json` | Historical HN data: AGENTS.md became a high-engagement community topic from 2025 onward. |
| D46 | [HN: Agents-lint context rot thread](https://news.ycombinator.com/item?id=47189911) | `articles/hn-agents-lint.json` | Small Show HN thread but directly relevant: stale paths, stale commands, and bloated context files need linting. |
| D47 | [HN search: codebase AI agents](https://hn.algolia.com/?q=%22AI%20coding%20agents%22%20codebase) | `articles/hn-search-codebase-ai-agents.json` | HN search snapshot for codebase-aware coding-agent tools and discussions. |
| D48 | [HN: Claude Code in an existing complex codebase](https://news.ycombinator.com/item?id=44774121) | `articles/hn-complex-codebase-claude-code.html`, `articles/hn-complex-codebase-claude-code.json` | HN discussion around planning/context setup for feature work in complex existing codebases. |
| D49 | [HN: Claude Code framework wars](https://news.ycombinator.com/item?id=45155302) | `articles/hn-claude-code-framework-wars.html` | HN discussion: subagents can isolate memory scanning and test failure summarization, but orchestration can become overbuilt. |
| D50 | [HN: Claude Code swarms](https://news.ycombinator.com/item?id=46743908) | `articles/hn-claude-code-swarms.json` | HN discussion around multi-agent orchestration, worktrees, API-contract failures, and context isolation. |
| D51 | [HN: How Claude Code works in large codebases](https://news.ycombinator.com/item?id=48144494) | `articles/hn-large-codebases-claude-code.html`, `articles/hn-large-codebases-claude-code.json` | Active May 2026 HN discussion of Anthropic's large-codebase article; confirms topic is current and popular. |
| D52 | [HN search: Claude Code codebase](https://hn.algolia.com/?q=%22Claude%20Code%22%20codebase) | `articles/hn-search-claude-code-codebase.json` | HN search snapshot for Claude Code + codebase discussions and tools. |
| D53 | [HN search: coding agent context](https://hn.algolia.com/?q=coding%20agent%20context) | `articles/hn-search-coding-agent-context.json` | HN search snapshot for context-window and context-management discussions around coding agents. |
