export function WhisperDeepDiveSlide() {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full max-w-6xl mx-auto px-8">
      ...
      <p className="text-lg text-muted-foreground mb-6 text-center max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr] gap-4 w-full mb-6 items-stretch">
        <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-4">
          ...
          <h3 className="text-xl font-bold text-primary mb-2">Audio -&gt; Mel</h3>
          <div className="inline-flex px-2 py-1 rounded-full bg-zinc-900/80 border border-zinc-700 text-xs font-mono text-muted-foreground mb-3">
        ...
        <div className="hidden md:flex items-center justify-center text-4xl text-primary/50">
          -&gt;
        </div>
        ...
        <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-4">
          ...
          <div className="inline-flex px-2 py-1 rounded-full bg-primary/10 border border-primary/30 text-xs font-mono text-primary mb-3">
