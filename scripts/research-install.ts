import { installResearcherRuntime } from "../internal/tools/researcher/runtime/install";
...
async function main(): Promise<void> {
  ...
  const result = await installResearcherRuntime({
...
main().catch((error: unknown) => {
  const message = error instanceof Error ? error.message : "Unknown runtime install error";
