...
export function StormDemoSlide() {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full max-w-5xl mx-auto px-8 text-center">
      ...
      >
        uv run main.py --agent=storm &quot;I am giving a presentation at Foo Caf&eacute; in
      ...
      >
        <p>Watch: Perspectives &rarr; Parallel interviews (WikiWriter &harr; TopicExpert)</p>
        <p>&rarr; Two-stage outline &rarr; Per-section writing &rarr; Lead + assembly</p>
      </motion.div>
    </div>
  );
}
