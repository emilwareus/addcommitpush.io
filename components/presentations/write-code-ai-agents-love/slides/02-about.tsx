...
const cards: AboutCard[] = [
  {
    content: (
      <div className="flex flex-col items-center gap-1.5 text-center">
        ...
        <span className="font-mono text-sm text-primary/50">oaiz.io</span>
      </div>
    ),
    rotate: -4,
    x: -540,
  ...
  },
  {
    content: (
      <div className="flex flex-col items-center gap-1.5 text-center">
        ...
        <span className="font-mono text-sm text-primary/50">debricked.com</span>
      </div>
    ),
    rotate: 5,
    x: 280,
  ...
  },
  {
    content: (
      <div className="flex flex-col items-center gap-1.5 text-center">
        ...
        <span className="font-mono text-sm text-primary/50">valkompass.ai</span>
      </div>
    ),
    rotate: -2,
    x: -540,
  ...
  },
  {
    content: (
      <div className="flex flex-col items-center gap-1.5 text-center">
        ...
        <span className="font-mono text-sm text-primary/50">podidex.com</span>
      </div>
    ),
    rotate: 3,
    x: 300,
  ...
  },
  {
    content: (
      <div className="flex flex-col items-center gap-1 text-center">
        <span className="font-mono text-base text-primary">addcommitpush.io</span>
